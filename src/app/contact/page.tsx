        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-primary p-6 relative">
                ...
                <div className="relative z-10 w-full max-w-md">
                    <div className="bg-white  p-10 rounded-3xl border border-border/40 hover:border-accent/40 transition-all group relative overflow-hidden text-center shadow-2xl">
