    ...
    return (
        <div className="flex h-screen bg-slate-50 overflow-hidden font-sans">
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
                <header className="h-20 border-b border-border bg-white flex items-center justify-between px-4 sm:px-8 z-20 print:hidden">
                ...
                <main className="flex-1 overflow-y-auto p-4 sm:p-8 bg-slate-50/50 print:bg-transparent print:p-0 print:overflow-visible">
                    {children}
                </main>
            </div>
        </div>
