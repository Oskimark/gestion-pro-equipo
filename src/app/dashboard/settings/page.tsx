...
export default function SettingsPage() {
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="bg-white dark:bg-slate-950 p-12 rounded-3xl border border-border/40 flex flex-col items-center justify-center text-center relative overflow-hidden">
