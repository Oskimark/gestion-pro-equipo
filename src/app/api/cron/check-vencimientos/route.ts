...
export async function GET(request: Request) {
    ...
    try {
		...
		// Corregido: Si existe tu variable, usa esa. Si no, busca la de Vercel.
	       let appUrl = process.env.NEXT_PUBLIC_APP_URL || (process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : 'https://gestion-pro-equipo.vercel.app');
